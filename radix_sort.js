        ...
        function GetPipelineRadixScan1_buf(count, has_group_buf, bInput, bData1, bData2, bGroup1, bGroup2) {
            ...
            for(let j=0; j<2; ++j) {
                const cs1 = new BABYLON.ComputeShader("shader_radix_scan1_" + j, RadixHelper.engine, { computeSource: get_shader_radix_scan1() }, { bindingsMapping:
                    {
        ...
        function GetPipelineRadixScan2_buf(buffers_scan1, buffers_scan2) 
        {
            ...
            for(let k=1; k<buffers_scan1.length; k++) {
                const cs2 = new BABYLON.ComputeShader("shader_radix_scan2_" + (k-1), RadixHelper.engine, { computeSource: get_shader_radix_scan2() }, { bindingsMapping:
                    {
